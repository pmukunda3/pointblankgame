...
[Serializable]
[PostProcess(typeof(GPU19ColorMissRepresentationBlendRenderer), PostProcessEvent.AfterStack, "Custom/GPU19ColorMissRepresentationBlend")]
public sealed class GPU19ColorMissRepresentationBlend : PostProcessEffectSettings {
...
public sealed class GPU19ColorMissRepresentationBlendRenderer : PostProcessEffectRenderer<GPU19ColorMissRepresentationBlend> {
    public override DepthTextureMode GetCameraFlags() {
        return DepthTextureMode.DepthNormals;
    }

	public override void Render(PostProcessRenderContext context) {
        var sheet = context.propertySheets.Get(Shader.Find("Hidden/Custom/GPU19ColorMissRepresentationBlendShader"));
